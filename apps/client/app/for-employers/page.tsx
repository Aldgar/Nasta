...
export default function ForEmployersPage() {
  ...
  const steps = [
    {
      num: "01",
      title: t("forEmployersPage.step0Title", "Post or request instantly"),
      desc: t("forEmployersPage.step0Desc"),
    },
    {
      num: "02",
      title: t(
        "forEmployersPage.step1Title",
        "Get matched with verified talent",
      ),
      desc: t("forEmployersPage.step1Desc"),
    },
    {
      num: "03",
      title: t("forEmployersPage.step2Title", "Book, monitor, and pay"),
      desc: t("forEmployersPage.step2Desc"),
    },
  ];
      ...
      <main className="mx-auto max-w-4xl px-6 pb-20 pt-28">
        ...
        <section className="mb-20">
          <h2 className="mb-10 text-2xl font-bold tracking-tight">
            {t("forEmployersPage.whyTitle", "Why clients choose Nasta")}
          </h2>
          ...
          <div className="space-y-3">
            {requirements.map((item) => (
              ...
              >
                ...
                >
                  {item.required
                    ? t("forEmployersPage.required", "Required")
                    : t("forEmployersPage.optional", "Optional")}
                </span>
              </div>
            ))}
          </div>
        ...
        <section className="text-center">
          ...
          <p className="mx-auto mb-8 max-w-md text-base text-[var(--muted-text)]">
            {t(
              "forEmployersPage.ctaDesc",
              "Create a free client account and post your first job in minutes.",
            )}
          </p>
          <Link
            href="/register"
          ...
          >
            {t("forEmployersPage.ctaButton", "Create Client Account")}
            <svg
