...
export default function ForServiceProvidersPage() {
  ...
  const steps = [
    {
      num: "01",
      title: t("forServiceProvidersPage.step0Title", "Create your profile"),
      desc: t("forServiceProvidersPage.step0Desc"),
    },
    {
      num: "02",
      title: t(
        "forServiceProvidersPage.step1Title",
        "Get instant job requests",
      ),
      desc: t("forServiceProvidersPage.step1Desc"),
    },
    {
      num: "03",
      title: t("forServiceProvidersPage.step2Title", "Work and get paid"),
      desc: t("forServiceProvidersPage.step2Desc"),
    },
  ];
      ...
      <main className="mx-auto max-w-4xl px-6 pb-20 pt-28">
        ...
        <section className="mb-20">
          <h2 className="mb-10 text-2xl font-bold tracking-tight">
            {t(
              "forServiceProvidersPage.whyTitle",
        ...
        <section className="mb-20">
          <div className="rounded-2xl border border-[var(--border-color)]/20 bg-white/[0.02] p-8 backdrop-blur-sm sm:p-10">
            <h2 className="mb-4 text-xl font-bold">
              {t(
                "forServiceProvidersPage.protectedTitle",
            ...
            <div className="space-y-3 text-sm leading-relaxed text-[var(--muted-text)]">
              <p>
                {t(
                  "forServiceProvidersPage.protectedP1",
                  "Before you start any job, the client's payment is already secured in Stripe escrow. Whether this is your full-time work or a side gig, you will never do work without the guarantee of getting paid.",
                )}
              </p>
              <p>
                {t(
                  "forServiceProvidersPage.protectedP2",
              ...
              <p>
                {t(
                  "forServiceProvidersPage.protectedP3",
        ...
        <section className="text-center">
          ...
          <p className="mx-auto mb-8 max-w-md text-base text-[var(--muted-text)]">
            {t(
              "forServiceProvidersPage.ctaDesc",
