...
export default function ForServiceProvidersPage() {
  ...
  const benefits = Array.from({ length: 6 }, (_, i) => ({
    icon: benefitIcons[i],
    title: t(`forServiceProvidersPage.benefit${i}Title`),
    desc: t(`forServiceProvidersPage.benefit${i}Desc`),
  }));

  const steps = [
    { num: "01", title: t("forServiceProvidersPage.step0Title", "Create your profile"), desc: t("forServiceProvidersPage.step0Desc") },
    { num: "02", title: t("forServiceProvidersPage.step1Title", "Get instant job requests"), desc: t("forServiceProvidersPage.step1Desc") },
    { num: "03", title: t("forServiceProvidersPage.step2Title", "Work and get paid"), desc: t("forServiceProvidersPage.step2Desc") },
  ];

  const requirements = Array.from({ length: 7 }, (_, i) => ({
    title: t(`forServiceProvidersPage.req${i}Title`),
    desc: t(`forServiceProvidersPage.req${i}Desc`),
  }));
      ...
      <main className="mx-auto max-w-4xl px-6 pb-20 pt-28">
        ...
        <section className="mb-20">
          <p className="mb-3 text-xs font-semibold uppercase tracking-[0.25em] text-[var(--primary)]">
            {t("forServiceProvidersPage.heroLabel", "For Service Providers")}
          </p>
          <h1 className="mb-6 text-4xl font-bold tracking-tight sm:text-5xl">
            {t("forServiceProvidersPage.heroTitle", "Earn instantly. On your terms.")}
          </h1>
          <p className="max-w-2xl text-lg leading-relaxed text-[var(--muted-text)]">
            {t("forServiceProvidersPage.heroDesc", "Whether it is your main income or a side gig, Nasta connects you with instant job requests from verified employers. Get paid fast, work on your schedule, and build your reputation.")}
          </p>
        </section>
        ...
        <section className="mb-20">
          <h2 className="mb-10 text-2xl font-bold tracking-tight">
            {t("forServiceProvidersPage.whyTitle", "Why service providers choose Nasta")}
          </h2>
        ...
        <section className="mb-20">
          <h2 className="mb-10 text-2xl font-bold tracking-tight">
            {t("forServiceProvidersPage.howTitle", "How it works")}
          </h2>
        ...
        <section className="mb-20">
          <h2 className="mb-3 text-2xl font-bold tracking-tight">
            {t("forServiceProvidersPage.verifyTitle", "Get verified once, earn forever")}
          </h2>
          <p className="mb-8 text-sm leading-relaxed text-[var(--muted-text)]">
            {t("forServiceProvidersPage.verifyDesc", "Complete your verification to unlock instant job requests and start earning. Every step builds your trust score and visibility.")}
          </p>
            ...
            {requirements.map((item) => (
              ...
              >
                ...
                <span className="flex-shrink-0 rounded-full bg-emerald-500/10 px-2.5 py-0.5 text-[10px] font-semibold text-emerald-400 ring-1 ring-emerald-500/20">
                  {t("forServiceProvidersPage.required", "Required")}
                </span>
              </div>
            ))}
          </div>
        ...
        <section className="mb-20">
          <div className="rounded-2xl border border-[var(--border-color)]/20 bg-white/[0.02] p-8 backdrop-blur-sm sm:p-10">
            <h2 className="mb-4 text-xl font-bold">
              {t("forServiceProvidersPage.protectedTitle", "Your earnings are protected")}
            </h2>
            <div className="space-y-3 text-sm leading-relaxed text-[var(--muted-text)]">
              <p>{t("forServiceProvidersPage.protectedP1", "Before you start any job, the employer's payment is already secured in Stripe escrow. Whether this is your full-time work or a side gig, you will never do work without the guarantee of getting paid.")}</p>
              <p>{t("forServiceProvidersPage.protectedP2", "Once the job is complete and confirmed, your earnings are released directly to your connected payout account. Most payouts arrive within 1-2 business days.")}</p>
              <p>{t("forServiceProvidersPage.protectedP3", "Nasta takes a small platform commission from each completed job to cover payment processing and platform operations. You always see the exact amount you will earn before accepting a job.")}</p>
            </div>
          </div>
        </section>
        ...
        <section className="text-center">
          <h2 className="mb-4 text-2xl font-bold tracking-tight">
            {t("forServiceProvidersPage.ctaTitle", "Ready to start earning?")}
          </h2>
          <p className="mx-auto mb-8 max-w-md text-base text-[var(--muted-text)]">
            {t("forServiceProvidersPage.ctaDesc", "Create a free account, verify your identity, and start applying for jobs today.")}
          </p>
          <Link
            href="/register"
          ...
          >
            {t("forServiceProvidersPage.ctaButton", "Create Free Account")}
