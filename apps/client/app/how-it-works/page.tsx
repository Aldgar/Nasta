...
export default function HowItWorksPage() {
  ...
  const steps = [
    { num: "01", title: t("howItWorks.step1Title", "Create your profile"), desc: t("howItWorks.step1Desc", "Sign up, verify your identity, and set your preferences.") },
    { num: "02", title: t("howItWorks.step2Title", "Request or apply"), desc: t("howItWorks.step2Desc", "Employers request on demand. Providers apply with one tap.") },
    { num: "03", title: t("howItWorks.step3Title", "Complete & get paid"), desc: t("howItWorks.step3Desc", "Job done, funds released instantly. Simple and transparent.") },
  ];
      ...
      <main className="mx-auto max-w-4xl px-6 pb-20 pt-28">
        ...
        <section className="mb-16">
          ...
          <h1 className="mb-6 text-4xl font-bold tracking-tight sm:text-5xl">
            {t("howItWorks.subtitle", "Verified before the first job. Trusted from day one.")}
          </h1>
          <p className="max-w-2xl text-lg leading-relaxed text-[var(--muted-text)]">
            {t("howItWorks.heroDesc", "We take trust seriously. Every user completes a verification process before they can post or accept a single job. Here is exactly what is required for each side.")}
          </p>
        </section>
            ...
            <div className="p-8 sm:p-10">
              <div className="mb-2 inline-flex items-center gap-2 rounded-full bg-[var(--primary)]/10 px-3 py-1 text-xs font-semibold text-[var(--primary)] ring-1 ring-[var(--primary)]/20">
                <svg className="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M11.42 15.17l-5.384-3.19m0 0a2.25 2.25 0 10-2.155 3.952 2.25 2.25 0 002.155-3.952zm0 0L6.75 7.77m5.67 7.4l5.384-3.19m0 0a2.25 2.25 0 10-2.155 3.952 2.25 2.25 0 002.155-3.952zm0 0l.743-5.45m-11.554 5.45L6.75 7.77m0 0a2.25 2.25 0 10-2.155-3.952 2.25 2.25 0 002.155 3.952zm0 0L12 12.77m0 0l5.25-4.999m-5.25 5l.743 5.45" />
                </svg>
              ...
              <p className="mb-8 text-sm leading-relaxed text-[var(--muted-text)]">
                {t("howItWorks.spFullDesc", "Complete your verification to unlock instant job requests and start earning. Every step builds your trust score and visibility to employers.")}
              </p>
        ...
        <section className="mb-20">
          <div className="relative overflow-hidden rounded-3xl border border-[var(--border-color)]/20 bg-white/[0.02] backdrop-blur-sm">
            ...
            <div className="p-8 sm:p-10">
              ...
              <p className="mb-8 text-sm leading-relaxed text-[var(--muted-text)]">
                {t("howItWorks.empFullDesc", "A lighter setup so you can start hiring fast. Add the essentials and request your first service provider today.")}
              </p>
              <div className="space-y-0.5">
                {empRequirements.map((item) => (
                  ...
                  >
                    ...
                    >
                      {item.required ? t("howItWorks.required", "Required") : t("howItWorks.optional", "Optional")}
                    </span>
                  </div>
                ))}
              </div>
              <div className="mt-8 rounded-xl border border-[var(--border-color)]/10 bg-white/[0.02] p-5">
                <p className="text-xs leading-relaxed text-[var(--muted-text)]">
                  <strong className="text-[var(--foreground)]">{t("howItWorks.quickStart", "Quick start:")}</strong>{" "}
                  {t("howItWorks.quickStartDesc", "You can browse verified service providers immediately after creating your account. Add your address and verify your phone to post your first job or send an instant request.")}
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-20 text-center">
          ...
          <p className="mx-auto max-w-lg text-sm leading-relaxed text-[var(--muted-text)]">
            {t("howItWorks.trustDesc", "These steps exist to protect everyone on the platform. Verified service providers get more job requests. Verified employers attract better talent. The result is a marketplace where both sides can work with confidence.")}
          </p>
        </section>
        ...
        <section>
          <div className="rounded-3xl border border-[var(--border-color)]/20 bg-white/[0.02] p-8 text-center backdrop-blur-sm sm:p-12">
            ...
            <p className="mx-auto mb-8 max-w-md text-sm leading-relaxed text-[var(--muted-text)]">
              {t("howItWorks.stillHaveQuestionsDesc", "Our team is here to help. Whether you need guidance on verification, payment, or anything else, reach out anytime.")}
            </p>
