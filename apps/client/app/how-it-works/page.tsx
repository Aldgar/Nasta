      ...
      <main className="mx-auto max-w-4xl px-6 pb-20 pt-28">
        ...
        <section className="mb-16">
          ...
          <p className="max-w-2xl text-lg leading-relaxed text-[var(--muted-text)]">
            We take trust seriously. Every user completes a verification process
            before they can post or accept a single job. Here is exactly what
            is required for each side.
          </p>
        </section>
            ...
            {[
              {
                ...
                desc: "Sign up, verify your identity, and set your preferences.",
              },
              {
                num: "02",
                title: "Request or apply",
                desc: "Employers request on demand. Providers apply with one tap.",
              },
              {
                num: "03",
                title: "Complete & get paid",
                desc: "Job done, funds released instantly. Simple and transparent.",
              },
            ].map((s) => (
              <div
                key={s.num}
          ...
          <div className="relative overflow-hidden rounded-3xl border border-[var(--border-color)]/20 bg-white/[0.02] backdrop-blur-sm">
            ...
            <div className="p-8 sm:p-10">
              ...
              <p className="mb-8 text-sm leading-relaxed text-[var(--muted-text)]">
                Complete your verification to unlock instant job requests and
                start earning. Every step builds your trust score and visibility
                to employers.
              </p>
        ...
        <section className="mb-20">
          <div className="relative overflow-hidden rounded-3xl border border-[var(--border-color)]/20 bg-white/[0.02] backdrop-blur-sm">
            ...
            <div className="p-8 sm:p-10">
              ...
              <p className="mb-8 text-sm leading-relaxed text-[var(--muted-text)]">
                A lighter setup so you can start hiring fast. Add the essentials
              ...
              <div className="mt-8 rounded-xl border border-[var(--border-color)]/10 bg-white/[0.02] p-5">
                <p className="text-xs leading-relaxed text-[var(--muted-text)]">
                  <strong className="text-[var(--foreground)]">Quick start:</strong>{" "}
                  You can browse verified service providers immediately after
                  creating your account. Add your address and verify your phone
                  to post your first job or send an instant request.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-20 text-center">
          ...
          <p className="mx-auto max-w-lg text-sm leading-relaxed text-[var(--muted-text)]">
            These steps exist to protect everyone on the platform. Verified
            service providers get more job requests. Verified employers attract
            better talent. The result is a marketplace where both sides can
        ...
        <section>
          <div className="rounded-3xl border border-[var(--border-color)]/20 bg-white/[0.02] p-8 text-center backdrop-blur-sm sm:p-12">
            ...
            <p className="mx-auto mb-8 max-w-md text-sm leading-relaxed text-[var(--muted-text)]">
              Our team is here to help. Whether you need guidance on
              verification, payment, or anything else, reach out anytime.
            </p>
