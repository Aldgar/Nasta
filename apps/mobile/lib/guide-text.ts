...
const guides: Record<GuideType, Record<Language, string>> = {
  ...
  EMPLOYER_INSTANT_JOBS: { en: EMPLOYER_INSTANT_JOBS_EN, pt: EMPLOYER_INSTANT_JOBS_PT },
  EMPLOYER_NEGOTIATION: { en: EMPLOYER_NEGOTIATION_EN, pt: EMPLOYER_NEGOTIATION_PT },
