export const TERMS_OF_SERVICE_PT = `# Termos de Serviço

**Última Atualização: \${new Date().toLocaleDateString('pt-PT', { year: 'numeric', month: 'long', day: 'numeric' })}**

## 1. Aceitação dos Termos

Ao aceder e utilizar a aplicação móvel Nasta ("App", "Plataforma", "Serviço"), concorda em ficar vinculado a estes Termos de Serviço ("Termos"). Se não concordar com estes Termos, não deve utilizar o Serviço.
...
- Envolver-se em assédio, discriminação ou discurso de ódio
