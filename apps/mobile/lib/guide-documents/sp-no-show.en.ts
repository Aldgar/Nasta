...
- No financial penalty is applied
- The no-show is recorded on your account

### Second Offense and Beyond
- A **€25 penalty** is deducted from your account balance for each additional no-show
- If your balance is insufficient, your balance will go **negative**
- The penalty must be covered before you can withdraw future earnings
...
- **Only accept jobs you can commit to** — If your schedule is uncertain, do not accept
...
If you have a legitimate reason for missing a job (medical emergency, accident, etc.), contact Nasta support immediately. While the no-show will still be recorded, the support team may review your case and waive the penalty at their discretion.
