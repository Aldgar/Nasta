...
Antes de se poder candidatar a empregos, deve ter completado:
1. **Verificação de email** — O seu endereço de email deve estar verificado
2. **Verificação de telefone** — O seu número de telefone deve estar verificado
3. **Identificação submetida** — Documentos KYC carregados e verificados
4. **Verificação de antecedentes** — Certificado de registo criminal submetido
5. **Foto de perfil** — Uma foto de perfil profissional carregada

Se algum destes estiver em falta, verá ecrãs de requisitos no processo de onboarding que o guiam para cada passo.

## Encontrar Empregos

### Feed de Empregos
Abra o separador principal de **Feed** para navegar pelos empregos disponíveis. Aqui verá:
- Título e descrição do emprego
- Categoria
- Localização
- Remuneração oferecida
- Tipo de emprego (Tempo Inteiro, Tempo Parcial, Biscate, Contrato)
- Nível de urgência

Os empregos são apresentados com os mais recentes primeiro. Percorra para encontrar empregos que correspondam às suas competências e disponibilidade.

## Como Se Candidatar

1. Toque num emprego para ver os detalhes completos
2. Reveja a descrição, requisitos, responsabilidades e remuneração
...
Se mudar de ideias depois de se candidatar:
1. Abra as suas candidaturas
2. Encontre a candidatura que quer retirar
3. Toque em **Retirar**
