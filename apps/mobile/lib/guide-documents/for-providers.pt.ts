export const FOR_PROVIDERS_PT = `# Para Prestadores de Serviços
...
### 1. Crie o Seu Perfil
Registe-se gratuitamente, verifique a sua identidade com um documento governamental e configure as suas competências e disponibilidade. Demora menos de cinco minutos.

### 2. Receba Pedidos de Trabalho Instantâneos
...
### 3. Trabalhe e Receba
Conclua a tarefa, faça check-out digitalmente e os fundos são libertados na sua conta de pagamento. Simples, rápido, transparente.

## O Que Precisa para Começar

- Verificação de Identidade (documento governamental) — Obrigatório
- Carta de Condução (3+ anos) — Obrigatório
- Verificação de Antecedentes Criminais — Obrigatório
- CV Profissional — Obrigatório
- Competências e Tarifas de Serviço (EUR) — Obrigatório
- Conta Bancária e Configuração de Pagamentos — Obrigatório
- Verificação de Telefone e Email — Obrigatório

## Os Seus Ganhos Estão Protegidos

- O pagamento é assegurado em custódia antes de começar
- Ganhos libertados na sua conta de pagamento após conclusão (1-2 dias úteis)
- Pequena comissão da plataforma
- Vê sempre os seus ganhos exatos antes de aceitar

Pronto para começar a ganhar? Crie uma conta gratuita, verifique a sua identidade e comece a candidatar-se a trabalhos hoje.
`;
