export const FOR_EMPLOYERS_EN = `# For Employers
...
### 2. Get Matched with Verified Talent
...
- Payment is secured in escrow before work begins
- Funds are released only on your confirmation
- Dispute resolution available with GPS logs and check-in records
- Small platform commission — you never pay more than the agreed price

Ready to hire? Create a free employer account and post your first job in minutes.
`;
