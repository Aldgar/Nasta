export const FOR_PROVIDERS_EN = `# For Service Providers
...
- Driver's License (3+ years) — Required
- Background & Criminal Record Check — Required
- Professional CV — Required
- Skills & Service Rates (EUR) — Required
- Bank Account & Payout Setup — Required
- Phone & Email Verification — Required

## Your Earnings Are Protected

- Payment is secured in escrow before you start
- Earnings released to your payout account on completion (1-2 business days)
- Small platform commission
- You always see your exact earnings before accepting

Ready to start earning? Create a free account, verify your identity, and start applying for jobs today.
`;
