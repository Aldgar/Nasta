...
Todos os utilizadores na Nasta têm a identidade verificada com documentos emitidos pelo governo. Os pagamentos são mantidos em custódia via Stripe até o trabalho estar concluído. O rastreamento GPS em tempo real e o check-in/check-out digital garantem total responsabilidade em cada tarefa.

## Contacte-nos

Se tiver alguma questão, contacte-nos em support@nasta.app
`;
