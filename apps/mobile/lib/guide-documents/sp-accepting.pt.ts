...
Quando recebe um pedido, abra-o para ver os detalhes completos do emprego:

- **Título** e descrição do emprego
- **Categoria** do trabalho
- **Localização** — onde o trabalho será realizado
- **Horário** — data e hora
- **Remuneração** — o pagamento oferecido
- **Requisitos** — quaisquer qualificações específicas necessárias
- **Tipo de emprego** — Tempo Inteiro, Tempo Parcial, Biscate ou Contrato
- **Indicações especiais** — se é necessário veículo ou carta de condução

Reveja tudo cuidadosamente antes de responder.
...
### Recusar
Se não pode aceitar o trabalho, toque em **Recusar**. Será pedido que forneça um motivo para a recusa.

Motivos comuns para recusar:
- Conflito de horário
- Localização demasiado longe
- Taxa demasiado baixa
